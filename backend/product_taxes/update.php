<?php
    ...
    class UpdateProductTaxController
    {
            ...
            if (!$validating_session) {
                ...
                if ($id === '') {
                    ...
                    try {
                        ...
                        $sql0 = "SELECT * FROM product_taxes WHERE id = :id";
                        ...
                        if ($stmt0->rowCount() != 0) {
                            $sql = "UPDATE product_taxes SET title = :title, description = :description WHERE id = :id";
    ...
    $updateProductTaxController = new UpdateProductTaxController();
    $updateProductTaxController->processRequest();