<?php
    ...
    class DeleteProductTaxController
    {
            ...
            if (!$validating_session) {
                ...
                if ($id == '') {
                    ...
                    try {
                        ...
                        $sql0 = "SELECT id FROM product_taxes WHERE id = :id";
    ...
    $deleteProductTaxController = new DeleteProductTaxController();
    $deleteProductTaxController->processRequest();