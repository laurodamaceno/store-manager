<?php
    ...
    class DeletePurchaseItemController
    {
            ...
            if (!$validating_session) {
                ...
                if ($id === '') {
                    ...
                    try {
                        ...
                        $sql0 = "SELECT id FROM purchase_items WHERE id = :id";
    ...
    $deletePurchaseItemController = new DeletePurchaseItemController();
    $deletePurchaseItemController->processRequest();